...
export interface ApiLivestreamCommentLivestreamComment
  extends Struct.CollectionTypeSchema {
  collectionName: 'livestream_comments';
  info: {
    displayName: 'LivestreamComment';
    pluralName: 'livestream-comments';
    singularName: 'livestream-comment';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::livestream-comment.livestream-comment'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiLivestreamLivestream extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    livestream_comments: Schema.Attribute.Relation<
      'oneToMany',
      'api::livestream-comment.livestream-comment'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery_location: Schema.Attribute.JSON;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variantData: Schema.Attribute.JSON;
  };
}
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    parent: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    rating: Schema.Attribute.Integer;
    replies: Schema.Attribute.Relation<'manyToOne', 'api::review.review'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    messages: Schema.Attribute.Relation<'oneToMany', 'api::message.message'>;
    midtransClientKey: Schema.Attribute.String;
    midtransServerKey: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::livestream-comment.livestream-comment': ApiLivestreamCommentLivestreamComment;
